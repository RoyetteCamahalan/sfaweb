                        ...
                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%">
                            <ItemTemplate>
                                <div class="text-center">
                                    ...
                                    <asp:LinkButton ID="btndeclinefundliq" CssClass="btn btn-danger btn-xs btn-flat" Visible="false" runat="server" CausesValidation="false" CommandArgument='<%# Eval("fundliquidationid") %>' OnClick="btndeclinefund_Click"> Reject
                                    </asp:LinkButton>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-append">
                                        ...
                                        <%--<asp:Button ID="btnAddVendor" runat="server" CssClass="btn btn-info btn-flat"><i class="fas fa-plus fa-fw"></i> </asp:Button>--%>
                                        <asp:LinkButton ID="btnAddVendor" runat="server" CssClass="btn btn-info btn-flat" OnClick="btnaddvendor_click"><i class="fas fa-plus fa-fw"></i></asp:LinkButton>
                                    </span>
                                    <span class="error invalid-feedback"><%= AppModels.ErrorMessage.required %></span>
                                </div>
                            </div>
...
<button type="button" id="btnopenvenmodal" data-toggle="modal" data-target=".lib-modal" hidden="hidden"></button>
<div class="modal fade lib-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <asp:UpdatePanel UpdateMode="Conditional" ID="upanelmodel" runat="server" ChildrenAsTriggers="false">
        <ContentTemplate>
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
